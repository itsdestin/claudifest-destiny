...
The desktop app uses a layered keyboard system. The text input auto-focuses when any printable character is typed, and auto-unfocuses after 1.5s of idle so global shortcuts become available.
