...
| 2026-03-15 | 1.1 | Updated hook references (sync-to-drive/sync-from-drive → git-sync.sh), updated encyclopedia dependency descriptions for local cache migration | Implementation | the user |
